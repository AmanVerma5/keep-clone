...
const Header=({ onSearch })=>{
  ...
  return(
    ...
    <div className="navbar">
      <div className="menu-logo-keep">
        <OverlayTrigger placement="bottom" overlay={<Tooltip>Main menu</Tooltip>}>
          <div className="menu">
